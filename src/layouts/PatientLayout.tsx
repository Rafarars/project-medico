          ...
          <div className="flex h-full flex-col">
            ...
            <div className="flex items-center space-x-3 border-b border-neutral-100 px-4 py-4 lg:py-5">
              ...
              <div className="flex-1 overflow-hidden">
                <h3 className="truncate text-sm lg:text-base font-medium text-neutral-900">{user?.name || 'Paciente'}</h3>
                <p className="truncate text-xs lg:text-sm text-neutral-500">Paciente</p>
              </div>
            </div>
            ...
            <nav className="flex-1 space-y-1 px-2 py-4 overflow-y-auto">
              ...
              >
                <Activity size={20} className="mr-3 text-neutral-400" />
              ...
              >
                ...
                <span className="text-sm lg:text-base">Mis Citas</span>
              </Link>
              <Link
                ...
                onClick={() => setSidebarOpen(false)}
              >
                <Pill size={20} className="mr-3 text-neutral-400" />
